...
tellraw @s {"rawtext":[{"text":"\n§l§uIsolate AntiCheat b8.7.6 Command Help"}]}
tellraw @s {"rawtext":[{"text":"\n§l§u--------------------------------------"}]}
...
tellraw @s {"rawtext":[{"text":"§u!adminlogs§r - Shows all commands run by operators (Isolate Commands)."}]}

tellraw @s {"rawtext":[{"text":"\n§l§dUtility and Tools Commands"}]}
