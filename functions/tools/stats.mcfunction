...
execute @s[scores={scaffoldvl=1..}] ~~~ tellraw @a[tag=notify] {"rawtext":[{"text":"§r§j[§uIsolate§j]§r "},{"selector":"@s"},{"text":" has "},{"score":{"name":"@s","objective":"towervl"}},{"text":" Scaffold violations."}]}
