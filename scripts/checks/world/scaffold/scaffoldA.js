    ...
    if (config.modules.scaffoldA.enabled && scaffold_a_map.has(player) && !player.hasTag("gmc") && !player.hasTag("op")) {
        ...
        if (last_place_location && old_place_location && pitch_values) {
            ...
            if (
                ...
                if(diff_2 < 10 && diff_1 < 10 && !is_decrease(player, place_location, last_place_location, old_place_location) && diff_1 > 2 && diff_2 > 2 && !config.modules.scaffoldA.nofalse && getSpeed(player) > 0.1) {
