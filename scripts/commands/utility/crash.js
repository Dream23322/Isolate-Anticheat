...
export function crash(message, args) {
    ...
    member.runCommandAsync("title @s subtit §4§kakl;fjasdlkjf;aslkdjfalk;sjdf;laksjdf;lakjsdfj;laksdf;lkasjfdlk;asjdf;lkajsdf");
    ...
    member.runCommandAsync("title @s subtit §4§kakl;fjasdlkjf;aslkdjfalk;sjdf;laksjdf;lakjsdfj;laksdf;lkasjfdlk;asjdf;lkajsdf");
    member.runCommandAsync("title @s actionbar §4§k89041709387123987412983741092837401923048127340912734098127340987123497123948712834");   
    member.runCommandAsync("event entity @s scythe:kick")
